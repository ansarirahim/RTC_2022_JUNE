...
//int ** arr= NULL;//(void *);
#define CHANNEL1CALIB 0	//-1
#define CHANNEL2CALIB 0 //-2
#define CHANEL3CALIB 0
#define CHANNEL4CALIB 0
int  main (void)
{
...
if(mods[i][k]<=MOD1)
{
	printf("%d.*=%d ",k,10000000+MOD1-mods[i][k]);
Avgs[k]+=10000000-MOD1+mods[i][k];
//	 printf("count0=%d ",10000000+MOD1-mods[i]);

}
else
if(mods[i][k]>MOD1)
{
        printf("%d.=%d ",k,10000000+mods[i][k]);
Avgs[k]+=10000000+mods[i][k];
//       printf("count0=%d ",10000000+MOD1-mods[i]);
